sap.ui.define(['sap/f/thirdparty/webcomponents-fiori', 'sap/f/thirdparty/query', 'sap/f/thirdparty/event-strict', 'sap/f/thirdparty/WrappingType', 'sap/f/thirdparty/ValueState', 'sap/f/thirdparty/willShowContent', 'sap/f/thirdparty/jsx-runtime', 'sap/f/thirdparty/NotificationListItemBase', 'sap/f/thirdparty/sys-enter-2', 'sap/f/thirdparty/information', 'sap/f/thirdparty/i18n-defaults', 'sap/f/thirdparty/Button2', 'sap/f/thirdparty/BusyIndicator', 'sap/f/thirdparty/Icon', 'sap/f/thirdparty/Link', 'sap/f/thirdparty/Tag', 'sap/f/thirdparty/Theme', 'sap/f/thirdparty/Icons', 'sap/f/thirdparty/decline', 'sap/f/thirdparty/overflow', 'sap/f/thirdparty/parameters-bundle.css2', 'sap/f/thirdparty/parameters-bundle.css', 'sap/f/thirdparty/ListItemBase', 'sap/f/thirdparty/FocusableElements', 'sap/f/thirdparty/AccessibilityTextsHelper', 'sap/f/thirdparty/toLowercaseEnumValue', 'sap/f/thirdparty/i18n-defaults2', 'sap/f/thirdparty/Label'], (function (webcomponentsBase, query, eventStrict, WrappingType, ValueState, willShowContent, jsxRuntime, NotificationListItemBase, sysEnter2, information, i18nDefaults, Button, BusyIndicator, Icon, Link, Tag, Theme, Icons, decline, overflow, parametersBundle_css, parametersBundle_css$1, ListItemBase, FocusableElements, AccessibilityTextsHelper, toLowercaseEnumValue, i18nDefaults$1, Label) { 'use strict';
    ...
    function NotificationListItemTemplate() {
        return (jsxRuntime.jsxs("li", { class: this.itemClasses, onFocusIn: this._onfocusin, onKeyDown: this._onkeydown, onKeyUp: this._onkeyup, onClick: this._onclick, tabindex: this.forcedTabIndex ? parseInt(this.forcedTabIndex) : undefined, "aria-labelledby": this.ariaLabelledBy, "aria-level": this._ariaLevel, children: [this.loading && (jsxRuntime.jsx("span", { id: `${this._id}-loading`, class: "ui5-hidden-text", children: this.loadingText })), jsxRuntime.jsx(BusyIndicator.BusyIndicator, { id: `${this._id}-busyIndicator`, delay: this.loadingDelay, active: this.loading, inert: this.loading, class: "ui5-nli-loading", children: jsxRuntime.jsxs("div", { class: "ui5-nli-content-wrapper", children: [jsxRuntime.jsxs("div", { class: {
                                    "ui5-nli-content": true,
                                    "ui5-nli-content-with-importance": this.hasImportance,
                                }, children: [this.hasImportance && (jsxRuntime.jsxs(Tag.Tag, { id: `${this._id}-importance`, class: "ui5-nli-importance", design: "Set2", colorScheme: "2", wrappingType: "None", children: [jsxRuntime.jsx(Icon.Icon, { name: iconHighPriority, slot: "icon" }), this.importanceText] })), jsxRuntime.jsxs("div", { class: "ui5-nli-title-text-wrapper", children: [this.hasState && (jsxRuntime.jsx(Icon.Icon, { class: "ui5-state-icon", name: this.statusIconName, showTooltip: true, accessibleName: this.stateText, design: this.statusIconDesign })), jsxRuntime.jsxs("div", { id: `${this._id}-title-text`, class: "ui5-nli-title-text", part: "title-text", children: [jsxRuntime.jsx("span", { class: "ui5-hidden-text", children: this.stateText }), this.titleText] })] }), jsxRuntime.jsx("span", { id: `${this._id}-read`, class: "ui5-hidden-text", children: this.readText }), this.hasDesc && (jsxRuntime.jsx("div", { id: `${this._id}-description`, class: "ui5-nli-description", children: jsxRuntime.jsx("slot", {}) })), jsxRuntime.jsxs("div", { class: "ui5-nli-footer", children: [jsxRuntime.jsx("div", { id: `${this._id}-footnotes`, class: "ui5-nli-footnotes", children: this.footerItems.map(item => {
                                                    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("slot", { name: item.slotName }), item.showDivider && jsxRuntime.jsx("div", { class: "ui5-nli-footer-divider", "aria-hidden": "true", children: "\u00B7" })] }));
                                                }) }), jsxRuntime.jsx(Link.Link, { class: "ui5-nli-footer-showMore", hidden: this.hideShowMore, onClick: this._onShowMoreClick, wrappingType: "None", href: "#" // --without href ENTER does not trigger click
                                                , accessibleName: this.moreLinkAccessibleName, accessibleRole: "Button", accessibilityAttributes: this.moreLinkAccessibilityAttributes, children: this.showMoreText })] })] }), jsxRuntime.jsxs("div", { class: "ui5-nli-actions", children: [this.showMenu && (jsxRuntime.jsx(Button.Button, { icon: overflow.overflowIcon, design: "Transparent", onClick: this._onBtnMenuClick, class: "ui5-nli-menu-btn", tooltip: this.menuBtnAccessibleName, accessibilityAttributes: this.menuButtonAccessibilityAttributes })), this.showClose && (jsxRuntime.jsx(Button.Button, { icon: decline.decline, class: "ui5-nli-close-btn", design: "Transparent", onClick: this._onBtnCloseClick, tooltip: this.closeBtnAccessibleName, accessibleName: this.closeBtnAccessibleName }))] }), jsxRuntime.jsx("div", { class: "ui5-nli-avatar", "aria-hidden": "true", children: jsxRuntime.jsx("slot", { name: "avatar" }) }), jsxRuntime.jsx("slot", { name: "menu" })] }) })] }));
    }
