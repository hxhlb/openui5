sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var DYNAMIC_PAGE_ARIA_LABEL_PIN_HEADER = "Закачи го заглавието";
	...
	var SHELLBAR_PROFILE = "Корисничко мени";
	var SHELLBAR_PRODUCTS = "Производи";
	var SHELLBAR_PRODUCT_SWITCH_BTN = "Бирач на производи";
	...
	var SIDE_NAVIGATION_PARENT_ITEM_SELECTABLE_DESCRIPTION = "За да појдете до ставката за навигацијата {0}, притиснете го копчето за празно место или Enter.";
	...
	var USER_MENU_EDIT_AVATAR_TXT = "Уреди ја профилната слика";
	var USER_MENU_EDIT_ACCOUNTS_TXT = "Уреди ја сметката";
	...
	var USER_SETTINGS_DIALOG_ACCESSIBLE_NAME = "Кориснички поставки";
