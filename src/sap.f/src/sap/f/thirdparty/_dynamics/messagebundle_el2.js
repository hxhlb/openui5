sap.ui.define(['exports'], (function (exports) { 'use strict';
	...
	var DATEPICKER_MOBILE_HEADER_TITLE = "Εισάγετε ημερομηνία";
	...
	var DATEPICKER_POPOVER_ACCESSIBLE_NAME = "Εισάγετε ημερομηνία για {0}";
	...
	var INPUT_SUGGESTIONS_EXPANDED = "Διευρυμένο";
	var INPUT_SUGGESTIONS_COLLAPSED = "Συνεπτυγμένο";
	...
	var LIST_ROLE_DESCRIPTION = "Λίστα με διαδραστικά στοιχεία. Για μετακίνηση στο περιεχόμενο πατήστε F2.";
	...
	var RANGE_SLIDER_START_HANDLE_DESCRIPTION = "Ελάχιστο";
	var RANGE_SLIDER_END_HANDLE_DESCRIPTION = "Μέγιστο";
	...
	var TOKEN_ARIA_DELETE = "Διαγραφή";
	...
	var CALENDAR_FOOTER_CANCEL_BUTTON = "Ακύρωση";
	var CALENDAR_FOOTER_OK_BUTTON = "ΟΚ";
	...
	var MENU_ITEM_END_CONTENT_ACCESSIBLE_NAME = "Πρόσθετες Ενέργειες";
	var MENU_ITEM_LOADING = "Φόρτωση";
	...
	var TABLE_ROW = "Σειρά";
	var TABLE_GROUP_ROW = "Σειρά Ομάδας";
	...
	var SWITCH_ON = "Ενεργό";
	var SWITCH_OFF = "Ανενεργό";
