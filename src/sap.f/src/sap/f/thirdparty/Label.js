sap.ui.define(['sap/f/thirdparty/webcomponents-fiori', 'sap/f/thirdparty/parameters-bundle.css', 'sap/f/thirdparty/jsx-runtime', 'sap/f/thirdparty/i18n-defaults2', 'sap/f/thirdparty/Theme', 'sap/f/thirdparty/Icons'], (function (webcomponentsBase, parametersBundle_css, jsxRuntime, i18nDefaults, Theme, Icons) { 'use strict';

    function LabelTemplate() {
        return (jsxRuntime.jsxs("label", { class: "ui5-label-root", onClick: this._onclick, children: [jsxRuntime.jsx("span", { class: "ui5-label-text-wrapper", children: jsxRuntime.jsx("slot", {}) }), jsxRuntime.jsx("span", { "aria-hidden": "true", class: "ui5-label-required-colon", "data-ui5-colon": this._colonSymbol })] }));
    }
